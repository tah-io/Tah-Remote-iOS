...
- (void)viewDidLoad
{
    ...
    arrayofImages = [[NSArray alloc]initWithObjects:@"frame.png",@"frame.png",@"frame.png",@"frame.png",nil];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    {
        RemoteViewController *detailViewController = [segue destinationViewController];
        
        detailViewController.sensor = self.sensor;
        
        detailViewController.title = @"Remote";
    ...
    else if ([[segue identifier] isEqualToString:@"Cell3"])
    {
        ...
        detailViewController.title = @"Social";
    }
